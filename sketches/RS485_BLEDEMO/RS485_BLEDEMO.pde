...
const char *RTC_TIME = "17:02:22:04:09:40:00";
int HOUR_FIRST_DIGIT = 2;
int HOUR_SECOND_DIGIT = 3;
...
const char *WELL_NAME = "BC01-%s"; // Only change value before the - , example if you want to make Well02 then it should be WELL02-%s
...
/*
        if (hourVal1 == HOUR_FIRST_DIGIT && hourVal2 == HOUR_SECOND_DIGIT) {
            ...
            //("days:hr:min:sec);
             BLE.sleep();
             PWR.deepSleep("00:07:00:00", RTC_OFFSET, RTC_ALM1_MODE2,SENS_OFF);
            // PWR.deepSleep("00:00:00:05", RTC_OFFSET, RTC_ALM1_MODE2,SENS_OFF);
        }
