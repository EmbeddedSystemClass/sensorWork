/*  
 *  ------ VC_05 - Configuration of the camera and record video -------- 
 *  
...
void loop(){ 
    ...
    if (status_3G == 1)
    {
        ...
        if (answer == 1)
        {
            _3G.cameraResolution(3);    // Sets QVGA resolution
            _3G.cameraFPS(2);          // Sets 15 FPS
            ...
            _3G.startVideo();    // Starts to record 15 seconds
            delay(15000);
            _3G.pauseVideo();    // Pauses 10 seconds
            delay(10000);
            _3G.resumeVideo();    // Resume the record 15 seconds
            delay(15000);
            _3G.stopVideo();    // Stops to record
