/*  
 *  --[SM_2] - Reading the Humidity Sensor on Smart Metering v20 board-- 
 *  
 *  Explanation: Turn on the sensor every eleven seconds, taking a measurement
 *               and printing its result through the USB port.
 *  
...
void loop()
{
  ...
  value = SensorSmartv20.readValue(SENS_SMART_HUMIDITY);
