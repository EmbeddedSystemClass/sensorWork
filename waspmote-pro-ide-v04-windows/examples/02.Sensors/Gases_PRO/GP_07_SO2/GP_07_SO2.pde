 ...
 *  ------------  [GP_07] - SO2  -------------- 
 *  
 *  Explanation: This is the basic code to manage and read the sulfur dioxide 
 *  (SO2) gas sensor. The concentration and the enviromental variables will be
...
char node_ID[] = "SO2_example";

void setup()
{
    USB.println(F("SO2 example"));
    // Set the Waspmote ID
    frame.setID(node_ID); 
}	
...
void loop()
{
    ...
    // Power off the SO2 sensor. If there aren't more gas sensors powered, 
    ...
    frame.addSensor(SENSOR_GP_SO2, concentration);
    // Add temperature
