 ...
 *  ------------  [GP_01] - C0  -------------- 
 *  
 *  Explanation: This is the basic code to manage and read the carbon monoxide
 *  (CO) gas sensor. The concentration and the enviromental variables will be 
...
void loop()
{
    ...
    // Power off the CO sensor. If there aren't more gas sensors powered, 
    ...
    frame.addSensor(SENSOR_GP_CO, concentration);
    // Add temperature
