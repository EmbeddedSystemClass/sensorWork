 ...
 *  ------------  [GP_06] - NO2  -------------- 
 *  
 *  Explanation: This is the basic code to manage and read the nitric dioxide 
 *  (NO2) gas sensor. The concentration and the enviromental variables will be
...
void loop()
{
    ...
    concentration = NO2.getConc();

    // Read enviromental variables
    temperature = NO2.getTemp(1);
    ...
    // Power off the NO2 sensor. If there aren't more gas sensors powered, 
    ...
    frame.addSensor(SENSOR_GP_NO2, concentration);
    // Add temperature
