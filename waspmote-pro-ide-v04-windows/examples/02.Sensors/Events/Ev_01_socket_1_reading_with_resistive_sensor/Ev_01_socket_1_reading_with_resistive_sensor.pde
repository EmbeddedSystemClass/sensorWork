/*  
 *  ------ [Ev_1] - Socket 1 Reading for Events v20-------- 
 *  
 *  Explanation: Turn on the Events Board v20 configuring the threshold
 *  of the socket 1 stage and wait for an interruption from this sensor
...
void setup()
{
  ...
  // Configure the socket 1 threshold
...
void loop()
{
  ...
  value = SensorEventv20.readValue(SENS_SOCKET1);
