/*  
 *  ------  3G_11 - UDP client in single connection  -------- 
 *  
 *  Explanation: This example shows how to create a UDP client 
        ...
        {    
            ...
            if (answer == 1)
            {
                ...
                if (answer == 1)
                {
                    ...
                    // 7. sends 'test_string'
                    answer = _3G.sendData(test_string, IP, port);
                    if (answer == 1) 
                    {
                        USB.println(F("Done"));
                    }
                    ...
                    // 8. sends a frame
                    answer = _3G.sendData(frame.buffer, IP, port, frame.length);
                    if (answer == 1) 
                    {
                        USB.println(F("Done"));
                    }
